...
void BasicDelayAudioProcessorEditor::resized()
{
    ...
    sliderFeedback->setBounds (64, 168, 150, 24);
    sliderDelayTime->setBounds (64, 64, 150, 24);
    labelDelayTime->setBounds (64, 24, 150, 24);
    labelFeedback->setBounds (64, 120, 150, 40);
...
<JUCER_COMPONENT documentType="Component" className="BasicDelayAudioProcessorEditor"
  ...
  <SLIDER name="feedback" id="c9b21a5c9a1b23a5" memberName="sliderFeedback"
          virtualName="" explicitFocusOrder="0" pos="64 168 150 24" min="0"
          max="0.94999999999999995559" int="0" style="LinearHorizontal"
          textBoxPos="TextBoxLeft" textBoxEditable="1" textBoxWidth="80"
          textBoxHeight="20" skewFactor="1" needsCallback="1"/>
  <SLIDER name="delay time" id="29b8b66ed74807b" memberName="sliderDelayTime"
          virtualName="" explicitFocusOrder="0" pos="64 64 150 24" min="0.010000000000000000208"
          max="1" int="0" style="LinearHorizontal" textBoxPos="TextBoxLeft"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1"
          needsCallback="1"/>
  <LABEL name="new label" id="e90807d371dde339" memberName="labelDelayTime"
         virtualName="" explicitFocusOrder="0" pos="64 24 150 24" edTextCol="ff000000"
         edBkgCol="0" labelText="Delay time (seconds)" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="15" bold="0" italic="0" justification="33"/>
  <LABEL name="new label" id="66e766e5d5dcca89" memberName="labelFeedback"
         virtualName="" explicitFocusOrder="0" pos="64 120 150 40" edTextCol="ff000000"
